<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="Hotel_management.Menu" %>
...
<body>
  ...
  <div class="form">
      <h3>Main Menu</h3>
        <br />
      <a href="Add Image.aspx"  style="background: #0026ff; padding:17px 98px;  color:white" >Add Image</a>
        <br />
        <br />
        <br />
     <a href="Add room.aspx"  style="background: #0026ff; padding:17px 99px;  color:white" >Add Room</a>
       <br />
       <br />
       <br />
    <a href="Manage Room.aspx"  style="background: #0026ff; padding:17px 85px;  color:white" >Manage Room</a>
