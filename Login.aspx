<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Hotel_management.WebForm4" %>
...
<body>
  ...
  <div class="form">
      ...
      <asp:Button class="btn btn-primary py-3 px-3 align-self-stretch" ID="Button1" runat="server" Text="Login" OnClick="Button1_Click"/>
